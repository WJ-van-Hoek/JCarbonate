...
/**
 * The {@code HCO3} class represents the concentration of bicarbonate (HCO3⁻) in
 * a solution, typically measured in units such as mmol/L. Bicarbonate is a
 * vital component of the carbonate buffering system, which helps regulate pH
 * levels in natural waters and biological systems, such as blood.
 *
 * <p>
 * In aqueous environments, bicarbonate is in equilibrium with dissolved carbon
 * dioxide (CO2aq), carbonic acid (H2CO3), and carbonate (CO3²⁻), forming a
 * critical part of the carbon cycle. The accurate representation of bicarbonate
 * concentration is crucial for understanding acid-base balance, ocean
 * acidification, and metabolic processes.
 * </p>
 *
 * <p>
 ...
 * <a href="https://en.wikipedia.org/wiki/Bicarbonate">Bicarbonate Wikipedia
 * page</a>.
 * </p>
 *
 * <p>
